...
*Resp.* As variáveis categóricas são *nome*; *sexo*;*sobreviveu*;*porto_embarque*.

*resp.* as variáveis numéricas são *idade*;*pais_filho*;*conjuge_irmão*;*passagem*;*classe*;*preço_passagem*;*cabine*.
...
*Resp.* *Barworth*; *Ele não possui nenhum parente ou cônjuge* 
...
*Resp.* *houve mais mortos do que sobreviventes* *números de mortos 549*; *números de sobreviventes 342*
...
*Resp.* *O sexo masculino teve o maior número de mortos, pois é isso que o gráfico monstra aparentemente.*
...
*Resp.* *A 1º classe teve uma maior número de sobreviventes é o menor número de mortos.*;

*A 2º classe foi a que aparentemente teve aproximadaamente quase o mesmo número de mortos e sobreviventes.*; 

*A 3º foi a que teve mais discrepância nos números, onde teve um número muito alto de mortos, é poucos sobreviventes.*
...
Qual a mediana? </br>
*Resp.*
*A média das idades é de 29 anos.*

*A mediana é 28 anos de idade*
...
*Resp.* *O que pode ver no gráfico é que os mais jovens conseguiu sobreviver, já os mais velhos e o que teve maior números de mortos.*
...
*Resp.* *Provavelmente não estavão na 1º classe quando ocorreu o naufrágio, não estava no lugar certo no momento certo.*

**Questão 10.**
Qual outra curiosidade você desejaria saber sobre esse conjunto de dados?

*resp.* *Quantos funcionarios sobreviveu ao naufrágio, pois só foi falado das pessoas que pagaram passagem.*

Proponha uma questão que não tenha sido abordada nas perguntas anteriores e, em seguida, responda-a utilizando o `R`.

Se quisermos saber o minimo é o maxímo das passsagem que foram pagaram, podemos usar a função `summarise()`:
