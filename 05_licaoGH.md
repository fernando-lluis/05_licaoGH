...
são *nome*; *sexo*;*sobreviveu*;*porto\_embarque*. *resp.* as variáveis
numéricas são
*idade*;*pais\_filho*;*conjuge\_irmão*;*passagem*;*classe*;*preço\_passagem*;*cabine*.
...
cônjuge que estavam no navio? </br> *Resp.* *Barworth*; *Ele não possui
nenhum parente ou cônjuge*
...
![](05_licaoGH_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
mais mortos do que sobreviventes* *números de mortos 549*; *números de
sobreviventes 342*
...
*Resp.* *549 pessoas não sobreviveu*
...
![](05_licaoGH_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
</br> *Resp.* *O sexo masculino teve o maior número de mortos, pois é
isso que o gráfico monstra aparentemente.*
...
![](05_licaoGH_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](05_licaoGH_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->

**Questão 06.** Qual a sua interpretação para esse fato? </br> *Resp.*
*A 1º classe teve uma maior número de sobreviventes é o menor número de
mortos.*; *A 2º classe foi a que aparentemente teve aproximadaamente
quase o mesmo número de mortos e sobreviventes.*; *A 3º foi a que teve
mais discrepância nos números, onde teve um número muito alto de mortos,
é poucos sobreviventes.*
...
![](05_licaoGH_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](05_licaoGH_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
*A média das idades é de 29 anos.* *A mediana é 28 anos de idade*
\#\#\#\# 3.3.1
...
![](05_licaoGH_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->

**Questão 08.** O que você pode afirmar sobre a mediana das idades dos
passageiros, em relação à sua sobrevivência ou não? </br> *Resp.* *O que
pode ver no gráfico é que os mais jovens conseguiu sobreviver, já os
mais velhos e o que teve maior números de mortos.*
...
anos (incluíndo esses extremos)? </br> *Resp.* *Provavelmente não
estavão na 1º classe quando ocorreu o naufrágio, não estava no lugar
certo no momento certo.*

**Questão 10.** Qual outra curiosidade você desejaria saber sobre esse
conjunto de dados? *resp.* *Quantos funcionarios sobreviveu ao
naufrágio, pois só foi falado das pessoas que pagaram passagem.*

Proponha uma questão que não tenha sido abordada nas perguntas
anteriores e, em seguida, responda-a utilizando o `R`.

Se quisermos saber o minimo é o maxímo das passsagem que foram pagaram,
podemos usar a função `summarise()`:
...
titanic %>% 
  ...
  drop_na() %>% 
  summarise(
    min_passagem = min(passagem),
    max_passagem = max(passagem)
  )
```

    ## # A tibble: 1 x 2
    ##   min_passagem max_passagem
    ##   <chr>        <chr>       
    ## 1 110152       WE/P 5735

*resp* *max foi de WE/P 5735.* *min foi de 110152.*
